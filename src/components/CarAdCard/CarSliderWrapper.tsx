        ...
        <div>
            <div className='relative w-full flex flex-col gap-2'>
                <div className='flex md:flex-row flex-col max-md:gap-2 w-full'>
                    <div className={cn(['relative rounded-lg w-full md:max-w-[335px]'])}>
                        <Image className='rounded-lg relative w-full h-full object-cover' src={activeImage} alt='image' />
                        <button onClick={() => setopenSlider(!openSlider)} className='bg-primary/20 text-white text-sm flex items-center gap-2 px-3 py-1 rounded absolute z-10 bottom-2 right-2'>
