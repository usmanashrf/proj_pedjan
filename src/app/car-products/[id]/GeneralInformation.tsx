...
import { generalInformationData1 } from "@/assets/data/general-information-data1";
...
const GeneralInformation = () => {
  return (
    <div className="bg-[#EDEEF0] w-full border border-black/25 rounded-md  py-5 mt-9  ">
      <h3 className="font-semibold text-xl px-4 ">General Information</h3>
      ...
      <div className="flex flex-1 md:text-xs  flex-col justify-between w-full gap-y-3 mt-4 ">
        {generalInformationData1.map((generalInformation, index) => (
          <div
            key={index}
          ...
          >
            ...
            <p className="text-black font-bold text-xs md:text-[12px] lg:pr-8 md:pr-5 pr-6">{generalInformation.value}</p>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-1 flex-col justify-between w-full  gap-y-3 mt-3 ">
        {generalInformationData2.map((generalInformation, index) => (
          <div
            key={index}
            className="flex justify-between items-center  "
          >
